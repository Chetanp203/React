        ...
        <div style={{ width: '100%', height: '55px', display: 'flex' }}>
            <div style={{ width: '100%', height: '55px', justifyContent: 'space-around', textAlign: 'center', display: 'flex' }}>
                <div style={{ display: 'flex', justifyContent: 'space-around', width: '35%', alignItems: 'center', color: 'grey' }}>
                    <h4 style={{ cursor: 'pointer' }}>First Citizen Club</h4>
                    <h4 style={{ cursor: 'pointer' }}>All Stores</h4>
                ...
                <div style={{ width: '35%', display: 'flex', alignItems: 'center' }}>
                    {user?.email ?
                        <>
                            ...
                            <i onClick={() => router('/product-from-backend')} className="fa-regular fa-heart fa-xl" style={{ color: '#000000', marginLeft: '15px', cursor: 'pointer' }}></i>

                            <i onClick={() => router('/cart')} className="fa-solid fa-bag-shopping fa-xl" style={{ color: '#000000', marginLeft: '15px', cursor: 'pointer' }}></i>

                            <i onClick={() => router('/profile')} className="fa-regular fa-circle-user fa-xl" style={{ color: '#000000', marginLeft: '15px', cursor: 'pointer' }}></i>
                            {/* <h3 onClick={logout} style={{marginLeft:'10px',cursor:'pointer'}}>Logout</h3> */}
                            <button onClick={logout} style={{ padding: '7px', backgroundColor: 'black', color: 'white', marginLeft: '10px', border: 'none', borderRadius: '7px', fontWeight: 'bold', cursor: 'pointer' }}>Logout</button>
                        </>
                        :
